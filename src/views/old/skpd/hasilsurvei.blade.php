...
<div class="container-fluid px-4">
  ...
  <ol class="breadcrumb">
    ...
    <a href="{{ url('adminskpd/layanan') }}" style="float:right" class="btn btn-danger">X</a>
    @if(count($resp)>0)
    ...
    <select onchange="if(this.value)location.href=this.value" id="">
      ...
      <option {{request('tahun') && request('tahun')==$r? 'selected':''}} value="{{url('adminskpd/respon-layanan/'.$id.'?tahun='.$r)}}">{{$r}}</option>
      @endforeach
    </select>
    @if(request('tahun'))
    <select onchange="if(this.value)location.href=this.value" id="">
      ...
      <option {{request('bulan') && request('bulan')==$r? 'selected':''}} value="{{url('adminskpd/respon-layanan/'.$id.'?tahun='.request('tahun').'&bulan='.$r)}}">{{blnindo($r)}}</option>
      @endforeach
    </select>
    @endif
    <br><br>
