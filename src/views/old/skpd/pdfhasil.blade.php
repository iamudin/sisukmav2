...
<table border="0" style="width:700px">
  <tr><td>Unit Pelayanan </td><td>: {{$skpd->nama_skpd}}</td></tr>
  <tr><td>Periode </td><td>: {{$periode}}</td></tr>
  <tr><td>Alamat </td><td>: {{$skpd->alamat}}</td></tr>
  <tr><td>Telp. Fax </td><td>: {{$skpd->telp}}</td></tr>
</table>
<br>
<?php
...
<table style="border-collapse:collapse;width:100%;border:none;font-size:7px" border="0">
<tr style="border:none"><td style="border:none" rowspan="12">
  Keterangan :<br>
...
@else 
<tr>
    <td colspan='10' align="center"><h1>Belum ada data</h1></td>
</tr>
@endif
</table>