                                                ...
                                                <div class="col-lg-12">
                                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                        ...
                                                        @if($type_unsur == 9)
                                                            ...
                                                            <li class="nav-item" role="presentation">
                                                                <button class="nav-link" id="ikm-kabv2-tab" data-bs-toggle="tab" data-bs-target="#ikm-kabv2" type="button" role="tab"
                                                                    aria-controls="ikm-kabv2" aria-selected="false"> <i class="fas fa-building"></i> IKM Kabupaten v2</button>
                                                            </li>
                                                          @endif
                                                        <li class="nav-item" role="presentation">
