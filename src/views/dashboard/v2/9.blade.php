    @if($data && count($data) > 0)
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content mt-3" id="ikmTabsContent9">
                    <div class="tab-pane fade" id="rekapitulasi" role="tabpanel">
                        <iframe style="width:100%;height:80vh"
                            src="{{ route('cetakrekap9v2') . '?' . request()->getQueryString() }}" frameborder="0"></iframe>
                    </div>
    ...
    @else
        @if(str($periode)->contains('2026'))
            <div class="alert alert-warning">Unsur 9 Tidak tersedia !</div>
        @endif
                    @if(!str($periode)->contains('2026'))
