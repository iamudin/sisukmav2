...
<div class="container-fluid px-4">
    <h3 class="mt-4" style="width:100%"> <i class="fas fa-desktop"></i> Data Perangkat Daerah  <a href="{{route('skpd.create')}}"  class="text-white btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Tambah</a></h3>
<br>
    ...
    <table id="datatablesSimple" class="table table-striped table-bordered" style="font-size:small">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="200px"><a href="{{ route('user.edit',$v->user->id) }}" class="badge bg-warning float-start me-2"> Edit </a><b> {{ $v->user?->username}}</b><br><small>Terkahir login : <br><span class="badge bg-dark">{{ $v->user?->last_login_at }}</span></small></td>
